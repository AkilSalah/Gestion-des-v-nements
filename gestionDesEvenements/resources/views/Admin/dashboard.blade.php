    ...
    <div class="bg-gray-50 px-4 py-10 font-[sans-serif] text-[#333]">
        ...
        <div class="grid sm:grid-cols-2 gap-6 max-w-6xl mx-auto">
          <div class="bg-white flex gap-6 max-lg:flex-col rounded-2xl md:p-8 p-6 shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.2)]">
            <h3 class="text-5xl font-extrabold"> {{$clients}} <span class="text-blue-600">M+</span></h3>
            <div>
          ...
          <div class="bg-white flex gap-6 max-lg:flex-col rounded-2xl md:p-8 p-6 shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.2)]">
            <h3 class="text-5xl font-extrabold"> {{$organisateur}} <span class="text-blue-600">K</span></h3>
            <div>
          ...
          <div class="bg-white flex gap-6 max-lg:flex-col rounded-2xl md:p-8 p-6 shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.2)]">
            <h3 class="text-5xl font-extrabold"> {{$categories}} <span class="text-blue-600">K</span></h3>
            <div>
          ...
          <div class="bg-white flex gap-6 max-lg:flex-col rounded-2xl md:p-8 p-6 shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.2)]">
            <h3 class="text-5xl font-extrabold"> {{$events}} <span class="text-blue-600">%</span></h3>
            <div>
